...
# Thêm thư mục cha của thư mục hiện tại vào sys.path
parent_dir = os.path.abspath(os.path.join(current_dir, '..')) # Đi tới thư mục gốc của dự án
sys.path.insert(0, parent_dir)


from common import get_list_file_in_folder
from visualize import viz_icdar
from rotation_corrector.predict import init_box_rectify_model
from rotation_corrector.utils.utils import rotate_image_bbox_angle
from rotation_corrector.filter import drop_box, get_mean_horizontal_angle, filter_90_box
from rotation_corrector.utils.line_angle_correction import rotate_and_crop
from config import rot_out_img_dir, rot_out_txt_dir, rot_out_viz_dir, det_out_txt_dir, raw_img_dir
from config import rot_drop_thresh, rot_visualize, rot_model_path
