...
from config import  raw_img_dir, det_out_txt_dir, gpu
img_dir = raw_img_dir
img_path=''
anno_dir = det_out_txt_dir
output_txt_dir = '/temp_output/txt'
output_viz_dir = '/temp_output/viz_imgs'
output_rotated_img_dir = 'R/temp_output/imgs'
