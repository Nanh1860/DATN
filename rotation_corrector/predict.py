...
from rotation_corrector.utils.utils import rotate_image_angle
...
class CheckQuality:
    ...
    def inference(self, image, debug=False):
        ...
        post_result = post_pr(preds.clone().detach().cpu().numpy())[0]
...
def predict_ud(visualize=False):
    ...
    imgs_dir = 'train_val_20200104'
    listfile = 'train_val_20200104/val.txt'
    weight_path = "train_20210105-1747/" \
